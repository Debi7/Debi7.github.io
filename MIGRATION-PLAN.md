...
| §4 `list.html` -> `PostList.astro`                   | Done        | Shared by /posts/ and /categories/<slug>/. Paginated since 2026-09-19, 5 posts a page, every list by year with a year switcher, through `ListByYear.astro` - see [PAGINATION.md](PAGINATION.md)                 |
