...
| Plan §9: every list split by year, 5 posts a page, through one component - [PAGINATION.md](PAGINATION.md); one button style on every list since the review - [REVIEW-FIXES.md](REVIEW-FIXES.md)                                                                                                                                                                                                                                                                                                                                               | `src/lib/posts.ts`, `ListByYear.astro`, `Pagination.astro`, `YearSwitcher.astro`, the `[...page].astro` routes |
