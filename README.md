...
| Plan §9: pagination by year on /posts/, 5 posts a page - [PAGINATION.md](PAGINATION.md); one button style on every list since the review - [REVIEW-FIXES.md](REVIEW-FIXES.md) | `src/lib/posts.ts`, `Pagination.astro`, `YearSwitcher.astro`, the `[...page].astro` routes |
